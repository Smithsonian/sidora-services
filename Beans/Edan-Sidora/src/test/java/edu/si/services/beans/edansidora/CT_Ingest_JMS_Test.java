...
public class CT_Ingest_JMS_Test extends CamelTestSupport {
    ...
    private static final RouteBuilder buildCtIngestMessage = new RouteBuilder() {
        ...
        public void configure() throws Exception {
            ...
            from("direct:start").routeId("BuildCtIngestMessageRoute")
                    ...
                    //.to("activemq:queue:edanIds.ct.update.test");
    ...
    @Test
    public void test_d53349() throws Exception {
        //ProjectId: p163
        //SiteId: d53349
        //SitePID: ct:12063885
        //ResearcherObservationPID: ct:12063891
        //VolunteerObservationPID: ct:12063893
        //ImageObservationPID:
        //ImageCount: 2
        //473K
        sendCtIngestMessage("ct:12063885");
    }
