 ...
 * @author jbirkhimer
 */
public class FITSServletException extends Exception {

    /**
     * Same behavior is as the super class
     */
    public FITSServletException() {
        super();
    }
     ...
     */
    public FITSServletException(String message) {
        super(message);
    }
     ...
     */
    public FITSServletException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause the cause of exception; same as the super class
     */
    public FITSServletException(String message, Throwable cause) {
        super(message, cause);
    }
}
