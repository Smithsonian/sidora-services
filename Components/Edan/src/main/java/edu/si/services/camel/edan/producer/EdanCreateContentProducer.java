 ...
 * @author jbirkhimer
 */
public class EdanCreateContentProducer extends AbstractEdanProducer {

    public EdanCreateContentProducer(EdanEndpoint endpoint, EdanConfiguration edanConfiguration, String edanPath) {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        if (isNotEmpty(edanEndpoint.getContent())) {
            //need to decode as URIBuilder encodes for us
            builder.setParameter("content", URLDecoder.decode(edanEndpoint.getContent(), "UTF-8"));
        }
