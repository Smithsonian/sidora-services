 ...
 * @author jbirkhimer
 */
public class EdanEditContentProducer extends AbstractEdanProducer {

    public EdanEditContentProducer(EdanEndpoint endpoint, EdanConfiguration edanConfiguration, String edanPath) {
