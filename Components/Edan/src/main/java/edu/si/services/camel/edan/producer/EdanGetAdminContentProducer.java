 ...
 * @author jbirkhimer
 */
public class EdanGetAdminContentProducer extends AbstractEdanProducer {

    private static final Logger log = LoggerFactory.getLogger(EdanGetAdminContentProducer.class);

    public EdanGetAdminContentProducer(EdanEndpoint endpoint, EdanConfiguration edanConfiguration, String edanPath) {
