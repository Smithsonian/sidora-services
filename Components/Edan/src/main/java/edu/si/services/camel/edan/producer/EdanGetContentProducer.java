 ...
 * @author jbirkhimer
 */
public class EdanGetContentProducer extends AbstractEdanProducer {

    public EdanGetContentProducer(EdanEndpoint endpoint, EdanConfiguration edanConfiguration, String edanPath) {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        if (isNotEmpty(edanEndpoint.getUrl())) {
            builder.setParameter("url", edanEndpoint.getUrl());
        }
        ...
        if (isNotEmpty(edanEndpoint.getLinkedContentType())) {
            builder.setParameter("linkedContentType", edanEndpoint.getLinkedContentType());
        }
