 ...
 * such loss or damage.
 */
package edu.smithsonian.services.camel.thumbnailator;
 ...
 * @author jshingler
 */
public class BlueprintThumbnailatorComponentTest extends CamelBlueprintTestSupport
{

    //@Test
    public void testBlueprintRoute() throws InterruptedException
    {
        getMockEndpoint("mock:result").expectedMessageCount(1);

        InputStream input = this.getClass().getResourceAsStream("/HappyBall.jpg");
    ...
    {
        return "/ThumbnailatorBlueprintRoute.xml";
    }
