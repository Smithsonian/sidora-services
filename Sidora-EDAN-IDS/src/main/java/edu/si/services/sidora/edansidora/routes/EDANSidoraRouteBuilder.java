...
package edu.si.services.sidora.edansidora.routes;
...
import edu.si.services.sidora.edansidora.aggregation.EdanBulkAggregationStrategy;
import edu.si.services.sidora.edansidora.aggregation.EdanIdsAggregationStrategy;
import edu.si.services.sidora.edansidora.aggregation.IdsBatchAggregationStrategy;
...
//                .log(LoggingLevel.ERROR, LOG_NAME, "${header.error}\nCamel Headers:\n${headers}");
        ...
        from("activemq:queue:{{edanIds.queue}}").routeId("EdanIdsStartProcessingFedoraMessage")
                ...
                .toD("http://useHttpUriHeader?headerFilterStrategy=#dropHeadersStrategy").id("processFedoraGetDatastreams")
                ...
                .setHeader(Exchange.HTTP_QUERY).simple("format=xml")
                .toD("http://useHttpUriHeader?headerFilterStrategy=#dropHeadersStrategy").id("processFedoraGetRELS-EXT")
        ...
        from("seda:processFedoraMessage?concurrentConsumers=" + Integer.valueOf(CONCURRENT_CONSUMERS)).routeId("EdanIdsProcessFedoraMessage")
                ...
                .toD("http://useHttpUriHeader?headerFilterStrategy=#dropHeadersStrategy").id("processFedoraGetManifestDatastream")
        ...
        from("seda:edanHttpRequest?concurrentConsumers=" + Integer.valueOf(CONCURRENT_CONSUMERS)).routeId("edanHttpRequest")
                ...
                .choice()
                    .when().simple("{{si.ct.batchEnabled}} == 'true' && ${header.edanServiceEndpoint} contains 'createContent'")
                        .aggregate(simple("${header.edanServiceEndpoint}"), new EdanBulkAggregationStrategy())
                            ...
                            .parallelProcessing(Boolean.parseBoolean(PARALLEL_PROCESSING))
                                ...
                                //EDAN endopint for bulk create (bulk edit is not available yet)
                                .setHeader("edanServiceEndpoint").simple("/content/v1.1/admincontent/createContentRows.htm")
        ...
        from("seda:createEdanJsonContent?concurrentConsumers=" + Integer.valueOf(CONCURRENT_CONSUMERS)).routeId("createEdanJsonContent")
                ...
                //.to("xslt-saxon:file:config/xslt/edan_Transform.xsl").id("transform2json")
                .to("xslt-saxon:file:config/xslt/edan_Transform_2_xml.xsl").id("transform2xml")
                ...
                .split(header("idsAssetList"))
                    ...
                    .choice()
                        ...
                        .when().simple("${body.isPublic} == 'Yes' && ${body.isInternal} == 'No'")
                            ...
                            .toD("http://useHttpUriHeader?headerFilterStrategy=#dropHeadersStrategy").id("idsAssetUpdateGetFedoraOBJDatastreamContent")
                    ...
                    .parallelProcessing(Boolean.parseBoolean(PARALLEL_PROCESSING))
                        ...
                        .choice()
                            .when().simple("${body} != null") // the asset xml should be in the body if it exists already
                                ...
                                //.toD("xslt:file:config/xslt/idsAssets.xsl").id("idsAssetXMLEndpointXSLT")
                            ...
                            .otherwise()
                                ...
                                .convertBodyTo(String.class)
                                .toD("velocity:file:config/templates/ids_template.vsl")
        ...
        from("seda:findParentObject?concurrentConsumers=" + Integer.valueOf(CONCURRENT_CONSUMERS)).routeId("EdanIdsFindParentObject").errorHandler(noErrorHandler())
                ...
                .toD("http://useHttpUriHeader?headerFilterStrategy=#dropHeadersStrategy")
                .convertBodyTo(String.class)
        ...
        from("seda:processCtDeployment?size=" + Integer.valueOf(CT_PROCESSING_QUEUE_SIZE)
                ...
                .split().tokenize(",", "PIDAggregation")
                    ...
                    .filter().simple("${body} not in '${header.ResearcherObservationPID},${header.VolunteerObservationPID},${header.ImageObservationPID}'")
                        ...
                        .toD("http://useHttpUriHeader?headerFilterStrategy=#dropHeadersStrategy").id("ctProcessGetFedoraDatastream")
