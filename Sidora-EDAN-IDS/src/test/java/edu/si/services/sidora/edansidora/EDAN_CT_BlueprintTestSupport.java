 ...
 * @author jbirkhimer
 */
public class EDAN_CT_BlueprintTestSupport extends CamelTestSupport {

    private static final Logger log = LoggerFactory.getLogger(EDAN_CT_BlueprintTestSupport.class);
    ...
    protected List<String> loadAdditionalPropertyFiles() {
        return Arrays.asList(KARAF_HOME + "/etc/system.properties", KARAF_HOME + "/etc/edu.si.sidora.karaf.cfg", KARAF_HOME + "/etc/application-test.properties");
    }
    ...
    protected CamelContext createCamelContext() throws Exception {
        ...
        if (routeList != null) {
            for (String route : routeList) {
                context.getRoute(route).setAutoStartup(false);
            }
        }
