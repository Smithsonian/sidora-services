...
import edu.si.services.sidora.edansidora.beans.EdanApiBean;
...
public class EdanAPITest extends CamelTestSupport {
    ...
    public static void loadConfig() throws Exception {
        ...
        assumeTrue(hostAvailabilityCheck(EDAN_TEST_URI, 80), "Edan Server Cannot be reached!");
    ...
    protected static List<String> loadAdditionalPropertyFiles() {
        return Arrays.asList(KARAF_HOME + "/etc/system.properties", KARAF_HOME + "/etc/edu.si.sidora.karaf.cfg", KARAF_HOME + "/etc/application-test.properties", KARAF_HOME + "/test.properties");
    }
    ...
    public void setUp() throws Exception {
        super.setUp();
        context.getRegistry().bind("edanApiBean", edanApiBean);
    }
    ...
    public void edanGetContentIdParamTest() throws Exception {
        ...
        Assertions.assertEquals("The returned ID does not match", TEST_EDAN_ID, result);
    }
    ...
    public void edanMetadataSearchTest() throws Exception {
        ...
        Assertions.assertEquals("The returned type does not match", TEST_TYPE, result);
    }
    ...
    public void edanMetadataSearchFilterQueryCtProjectIdTest() throws Exception {
        ...
        Assertions.assertEquals("The returned ProjectId does not match", TEST_PROJECT_ID, result_projectId);
    }
    ...
    public void edanMetadataSearchFilterQueryCtDeploymentIdTest() throws Exception {
        ...
        assumeTrue(StringUtils.isNotEmpty(result_deploymentId), "The EDAN response does not contain our test EDAN Id:" + TEST_EDAN_ID);

        LOG.info("Expected DeploymentId = {}, Returned DeploymentId = {}", TEST_DEPLOYMENT_ID, result_deploymentId);
        Assertions.assertEquals("The returned DeploymentId does not match", TEST_DEPLOYMENT_ID, result_deploymentId);
    ...
    public void edanMetadataSearchFilterQueryCtProjectAndDeploymentIdTest() throws Exception {
        ...
        assumeTrue(StringUtils.isNotEmpty(result_deploymentId) && StringUtils.isNotEmpty(result_projectId), "The EDAN response does not contain our test EDAN Id:" + TEST_EDAN_ID);
    ...
    public void edanMetadataSearchFilterQueryImageIdTest() throws Exception {
        ...
        Assertions.assertEquals(1, json.getJSONArray("rows").length(), "Result Count does not match.");
        ...
        Assertions.assertEquals(1, result_count, "The returned Row Count does not match");
        ...
        Assertions.assertEquals("The returned ImageId does not match", TEST_IAMGE_ID, result_imageId);
    ...
    public void edanMetadataSearchFilterQueryIdsIdTest() throws Exception {
        ...
        Assertions.assertEquals("The returned IdsId does not match", props.getProperty("si.edu.idsAssetImagePrefix") + TEST_IAMGE_ID, result_idsId);
    ...
    public void edanMetadataSearchFilterQueryUnmarshalJSONTest() throws Exception {
        ...
        Assertions.assertEquals("d33997s6i1", edanSearch.getRows().get(0).getContent().getImage().getId());
    ...
    public void solrEdan9010Test() throws Exception {
        ...
        assumeTrue(hostAvailabilityCheck(SOLR_SERVER, SOLR_PORT), "The Solr Server could not be found! Make sure you are connected to SI VPN if you want this test to run!");
        ...
        Assertions.assertEquals("The returned app_id does not match", TEST_APP_ID, result_appId);
        ...
        Assertions.assertTrue(result_url.equalsIgnoreCase(TEST_IAMGE_ID), "The returned url does not match");
        ...
        Assertions.assertEquals("The returned id does not match", TEST_EDAN_ID, result_id);
    }
    ...
    public void solrIDSTest() throws Exception {
        ...
        Assertions.assertEquals("The returned archive does not match", expected_archive, result_archive);
        ...
        Assertions.assertEquals("The returned uan does not match", expected_uan, result_uan);
        ...
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from("direct:createEdanJsonContent").routeId("createEdanJsonContent")
                        ...
                        //.to("xslt-saxon:file:{{karaf.home}}/Input/xslt/edan_Transform.xsl").id("transform2json")
                        .to("xslt-saxon:file:{{karaf.home}}/Input/xslt/edan_Transform_2_xml.xsl").id("transform2xml")
