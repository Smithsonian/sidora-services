...
public class EdanAPITest extends CamelTestSupport {
    ...
    protected static List<String> loadAdditionalPropertyFiles() {
        return Arrays.asList(KARAF_HOME + "/etc/system.properties", KARAF_HOME + "/etc/edu.si.sidora.karaf.cfg", KARAF_HOME + "/etc/edu.si.sidora.emammal.properties", KARAF_HOME + "/test.properties");
    }
    ...
    protected JndiRegistry createRegistry() throws Exception {
        ...
        //jndiRegistry.bind("edanApiBean", EdanApiBean.class);
