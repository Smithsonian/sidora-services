...
package edu.si.sidora.mci.routes;

import com.mysql.cj.jdbc.exceptions.CommunicationsException;
import edu.si.services.fedorarepo.FedoraObjectNotFoundException;
import edu.si.sidora.mci.SidoraMCIException;
...
public class SidoraMCIServiceRouteBuilder extends RouteBuilder {
    ...
    String addRequest = "sql:{{sql.addRequest}}?dataSource=#requestDataSource";
    ...
    public void configure() throws Exception {
        ...
        onException(ValidationException.class, XPathException.class)
                .onWhen(simple("${routeId} == 'AddMCIProject'"))
                .handled(true)
        ...
        onException(SidoraMCIException.class)
                .useExponentialBackOff()
                .backOffMultiplier("{{mci.backOffMultiplier}}")
                .redeliveryDelay("{{mci.redeliveryDelay}}")
                .maximumRedeliveries("{{mci.maximumRedeliveries}}")
        ...
        from("direct:addProject").routeId("AddMCIProject")
                ...
                .process(exchange -> exchange.getIn().setHeader("correlationId", UUID.randomUUID().toString()))
                ...
                .to("validator:file:config/schemas/MCIProjectSchema.xsd").id("MCIProjectSchemaValidation")
                .toD("xslt-saxon:file:config/xslt/MCIProjectToSIdoraProject.xsl").id("xsltMCIProjectToSIdoraProject")
                .log(LoggingLevel.DEBUG, "Transform Successful")
                .setHeader("mciProjectDESCMETA", simple("${body}", String.class))

                .removeHeaders("*","mciProjectXML|correlationId")
        ...
        from("direct:workbenchLogin").routeId("MCIWorkbenchLogin")
                ...
                .toD("https://useHttpUriHeader?headerFilterStrategy=#dropHeadersStrategy&throwExceptionOnFailure=false")
                ...
                .choice()
                    ...
                    .otherwise()
                        ...
                        .throwException(SidoraMCIException.class, "${id} ${routeId}: Workbench Login Failed!!! Response Code: ${header.CamelHttpResponseCode}, Response: ${header.CamelHttpResponseText}, Response Cookie: ${header.Set-Cookie}")
                    .endChoice()
                .end()
        ...
        from("direct:workbenchCreateResearchProject").routeId("MCIWorkbenchCreateResearchProject")
                ...
                .choice()
                    ...
                    .otherwise()
                        ...
                        .throwException(SidoraMCIException.class, "${id} ${routeId}: Workbench Create Research Project Failed!!! Response Code: ${header.CamelHttpResponseCode}, Response: ${header.CamelHttpResponseText}, Body: ${body}")
                    .endChoice()
                .end()
        ...
        from("direct:findFolderHolderUserPID").routeId("MCIFindFolderHolderUserPID").errorHandler(noErrorHandler())
                ...
                .choice()
                    .when().simple("${header.drupalUserData} != null")
                        ...
                        .toD("exec:php?useStderrOnEmptyStdout=true").id("phpDeserializeUserData") //TODO: verify this still works
                    ...
                    .otherwise()
                        ...
                        .process(exchange -> { throw new SidoraMCIException(exchange.getIn().getBody(String.class)); }).id("throwMCIException")
        ...
        from("direct:mciCreateConcept").routeId("MCICreateConcept")
                ...
                .toD("velocity:file:config/templates/MCIProjectSidoraTemplate.vsl").id("velocityMCIProjectSidoraTemplate")
                ...
                .toD("xslt-saxon:file:config/xslt/MCIProjectSIdoraConcept2DC.xsl").id("xsltProjectSIdoraConcept2DC")
                ...
                .toD("velocity:file:config/templates/MCIProjectTemplate.vsl").id("velocityMCIProjectTemplate")
        ...
        from("direct:mciCreateResource").routeId("MCICreateResource")
                ...
                //Add the DESCMETA Datastream
                .toD("xslt-saxon:file:config/xslt/MCIProjectToSIdoraGeneralResource.xsl").id("xsltMCIProjectToSIdoraGeneralResource")
                .toD("fedora:addDatastream?name=DESCMETA&type=text/xml&group=X&dsLabel=DESCMETA%20Record&versionable=true")

                //Update the DC datastream
                .toD("xslt-saxon:file:config/xslt/MCIProjectSIdoraConcept2DC.xsl").id("xsltResourceSIdoraConcept2DC")
                .toD("fedora:addDatastream?name=DC&type=text/xml&group=X")

                //Add the RELS=EXT Datastream
                .toD("velocity:file:config/templates/MCIResourceTemplate.vsl").id("velocityMCIResourceTemplate")
                .toD("fedora:addDatastream?name=RELS-EXT&type=application/rdf+xml&group=X&dsLabel=RDF%20Statements%20about%20this%20object&versionable=false")
...
//                .toD("cxfrs:{{fits.host}}?headerFilterStrategy=#dropHeadersStrategy").id("fitsRequest")
...
//                .log(LoggingLevel.INFO, LOG_NAME, "Finished processing FITS...");
        ...
        from("direct:FindObjectByPIDPredicate")
                ...
                .setBody().xpath("//ri:boolean/text()", Boolean.class, ns)
                ...
                .filter().simple("${body} == false")
                        ...
                        .throwException(FedoraObjectNotFoundException.class, "${body}")
                        //.process(exchange -> {throw new FedoraObjectNotFoundException(exchange.getIn().getBody(String.class));})
                .end()
