...
public class MCIFolderHolderPHPTest extends CamelTestSupport {
    ...
    protected List<String> loadAdditionalPropertyFiles() {
        return Arrays.asList(KARAF_HOME + "/etc/system.properties", KARAF_HOME + "/etc/edu.si.sidora.karaf.cfg", KARAF_HOME + "/etc/edu.si.sidora.mci.cfg", KARAF_HOME + "/sql/mci.sql.properties");
    }
    ...
    protected JndiRegistry createRegistry() throws Exception {
        ...
        reg.bind("drupalDataSource", MYSQL_DB);
