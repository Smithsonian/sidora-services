...
public class MCISchemaValidationTest extends CamelTestSupport {
    ...
    private static final Logger log = LoggerFactory.getLogger(MCISchemaValidationTest.class);
        ...
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from("direct:transform")
                        .doTry()
                        .toD("xslt-saxon:file:target/test-classes/Input/xslt/MCIProjectToSIdoraProject.xsl").id("xsltMCIProjectToSIdoraProject")
