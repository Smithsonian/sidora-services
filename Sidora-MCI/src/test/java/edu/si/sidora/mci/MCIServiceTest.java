...
public class MCIServiceTest extends MCI_BlueprintTestSupport {
    ...
    private static final Logger log = LoggerFactory.getLogger(MCIServiceTest.class);
    ...
    public void testRequestOKResponse() throws Exception {
        ...
        AdviceWithRouteBuilder.adviceWith(context, "AddMCIProject", a -> {
                //Skip adding request to database
                a.weaveById("createRequest").remove();
                //Skip further processing since all we are interested in is the return response
                a.weaveByToString(".*seda:processProject.*").remove();
        });
    ...
    public void testValidationFailedErrorResponse() throws Exception {
        ...
        AdviceWithRouteBuilder.adviceWith(context, "AddMCIProject", a -> {
                //Skip adding request to database
                a.weaveById("createRequest").remove();
                a.weaveById("onExceptionAddValidationErrorsToDB").remove();
                //Skip further processing since all we are interested in is the return response
                a.weaveByToString(".*seda:processProject.*").remove();
        });
    ...
    public void testSQLExceptionAndRetriesForAddMCIProjectRoute() throws Exception {
        ...
        AdviceWithRouteBuilder.adviceWith(context, "AddMCIProject", a -> {
                ...
                a.weaveById("createRequest").replace().process(processor);
                a.weaveById("sedaProcessProject").remove();
    ...
    public void testFolderHolderNotFoundRetry() throws Exception {
        ...
        mockResult.message(0).exchangeProperty(Exchange.EXCEPTION_CAUGHT).isInstanceOf(SidoraMCIException.class);
        ...
        AdviceWithRouteBuilder.adviceWith(context, "ProcessMCIProject", a -> {
                a.weaveById("MCI_ExceptionOnException").after().to("mock:error");
                a.weaveById("consumeRequest").remove();
                a.weaveById("folderHolderXpath").remove();
                a.weaveById("researchProjectLabelXpath").remove();
                a.weaveById("setOwnerPID").before().to("mock:result").stop();
        });

        AdviceWithRouteBuilder.adviceWith(context, "MCIFindFolderHolderUserPID", a -> {

                //processor used to replace sql query to test onException and retries
                final Processor processor = new Processor() {
                    public void process(Exchange exchange) throws SidoraMCIException {
                        Message in = exchange.getIn();
                        in.setHeader("redeliveryCount", in.getHeader(Exchange.REDELIVERY_COUNTER, Integer.class));
                        throw new SidoraMCIException("Folder Holder User PID Not Found!!!");
                    }
                };

                a.weaveById("queryFolderHolder").remove();
                a.weaveById("throwMCIException").replace().process(processor);
        });
    ...
    public void testAllOtherExceptionsDuringProcessMCIProjectRoute() throws Exception {
        ...
        AdviceWithRouteBuilder.adviceWith(context, "ProcessMCIProject", a -> {
                ...
                a.weaveById("processProjectOnExceptionSQL").replace().to("mock:error");
                a.interceptFrom().process(processor).to("mock:result");
        });
    ...
    public void testMCICreateResource() throws Exception {
        ...
        AdviceWithRouteBuilder.adviceWith(context, "MCICreateResource", a -> {
                a.interceptSendToEndpoint(".*fedora:.*").skipSendToOriginalEndpoint().log(LoggingLevel.INFO, LOG_NAME, "Skip Sending to Fedora").to("mock:fedora");
                a.weaveAddLast().to("mock:result").stop();
        });

        AdviceWithRouteBuilder.adviceWith(context, "MCIProjectAddFITSDataStream", a -> {
                a.interceptSendToEndpoint(".*fedora:.*").skipSendToOriginalEndpoint().log(LoggingLevel.INFO, LOG_NAME, "Skip Sending to Fedora").to("mock:fedora");

                a.weaveById("fitsRequest").replace().setHeader("CamelHttpResponseCode").simple("200").setBody().simple("Test Fits Output");
        });
    ...
    public void testResourceProjectLabelProcessMCIProjectRoute() throws Exception {
        ...
        AdviceWithRouteBuilder.adviceWith(context, "ProcessMCIProject", a -> {
                a.weaveById("consumeRequest").remove();
                a.weaveById("researchProjectLabelXpath").after().to("log:testMCI?showAll=true&multiline=true&maxChars=100000").to("mock:result").stop();
        });
    ...
    public void testWorkbenchLoginSetCookie() throws Exception {
        ...
        AdviceWithRouteBuilder.adviceWith(context, "MCIWorkbenchLogin", a -> {
                a.weaveById("workbenchLogin").replace()
                        .setHeader(Exchange.HTTP_RESPONSE_CODE).simple("302");
                a.weaveById("workbenchLoginCreateResearchProjectCall").replace().to("mock:result");
        });
    ...
    public void testWorkbenchLogin() throws Exception {
        ...
        AdviceWithRouteBuilder.adviceWith(context, "MCIWorkbenchLogin", a -> {
                ...
                a.weaveById("mciWBLoginParseSet-CookieHeader")
                        .after()
                        .process(new Processor() {
                            @Override
                            public void process(Exchange exchange) throws Exception {
        ...
        AdviceWithRouteBuilder.adviceWith(context, "MCIWorkbenchCreateResearchProject", a ->
                a.weaveById("workbenchCreateResearchProject")
                        .after()
                        .process(new Processor() {
                            @Override
                            public void process(Exchange exchange) throws Exception {
    ...
    public void testWorkbenchCreateResearchProject() throws Exception {
        ...
        AdviceWithRouteBuilder.adviceWith(context, "MCIWorkbenchCreateResearchProject", a -> {
                a.weaveById("workbenchCreateResearchProject").replace()
    ...
    public void testMciProjectTemplate() throws Exception {
        ...
        context.addRoutes(new RouteBuilder() {
            ...
            public void configure() throws Exception {
                from("direct:start")
                        .toD("xslt-saxon:file:{{karaf.home}}/Input/xslt/MCIProjectToSIdoraProject.xsl")
        ...
        AdviceWithRouteBuilder.adviceWith(context, "MCICreateConcept", a -> {
                a.interceptSendToEndpoint(".*fedora:.*").skipSendToOriginalEndpoint().log(LoggingLevel.INFO, LOG_NAME, "Skip Sending to Fedora");
                a.weaveById("mciCreateResource").replace().log("Skipping Create Resource");
                a.weaveById("velocityMCIProjectTemplate").after().to("mock:result");
        });
    ...
    public void testMciLabel() throws Exception {
        ...
        AdviceWithRouteBuilder.adviceWith(context, "MCICreateConcept", a ->
                a.weaveById("mciLabel1").after().setBody().simple("${header.mciLabel}").to("mock:result").stop());
    ...
    public void testDrupalUserDataDeserialize() throws Exception {
        ...
        AdviceWithRouteBuilder.adviceWith(context, "MCIFindFolderHolderUserPID", a -> {
                a.weaveById("queryFolderHolder").replace().setHeader("drupalUserData").simple("a:6:{s:16:\"ckeditor_default\";s:1:\"t\";s:20:\"ckeditor_show_toggle\";s:1:\"t\";s:14:\"ckeditor_width\";s:4:\"100%\";s:13:\"ckeditor_lang\";s:2:\"en\";s:18:\"ckeditor_auto_lang\";s:1:\"t\";s:18:\"islandora_user_pid\";s:9:\"si-user:5\";}");
                a.weaveById("phpDeserializeUserData").after().to("mock:result").stop();
        });
