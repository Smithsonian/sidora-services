...
public class MCI_WBLoginCookieTest extends CamelTestSupport {
    ...
    private static final Logger log = LoggerFactory.getLogger(MCI_WBLoginCookieTest.class);
        ...
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from("direct:login")
                        ...
                        .toD("https://useHttpUriHeader?throwExceptionOnFailure=false&loggingFeatureEnabled=true&exchangePattern=InOut")
                        .id("workbenchLogin")
