...
package edu.si.sidora.tabular.metadata;
...
@Deprecated
@Path("/")
public class TabularMetadataGeneratorEndpointImpl  implements TabularMetadataGeneratorEndpoint{

    private static final Logger log = getLogger(TabularMetadataGeneratorEndpointImpl.class);
    ...
    public TabularMetadataGeneratorEndpointImpl() {
        generator = new TabularMetadataGenerator();
        translator = new ExcelToTabular();
    }

    public Codebook getCodebook(URL url, boolean hasHeaders, int scanLimit) throws URISyntaxException, IOException {
