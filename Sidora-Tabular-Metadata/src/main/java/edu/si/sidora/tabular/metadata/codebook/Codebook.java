...
package edu.si.sidora.tabular.metadata.codebook;

import edu.si.sidora.tabular.metadata.generator.TabularMetadata;
...
import static edu.si.sidora.tabular.metadata.codebook.Codebook.VariableType.EnumerationList.enumerationList;
import static edu.si.sidora.tabular.metadata.codebook.Codebook.VariableType.RangeType.rangeType;
...
public class Codebook {
    ...
    public List<VariableType> getVariables() {
        ...
        for (int i = 0; i < metadata.headerNames().size(); i++) {
            ...
            output.add(VariableType.variableType(name, unparseableOverTotal, type, range, enumeration));
        }
        return output;
    }
