...
package edu.si.sidora.tabular.metadata.generator.heuristics.enumerations;
...
import edu.si.sidora.tabular.metadata.generator.heuristics.AbstractHeuristic;
...
public class InMemoryEnumeratedValuesHeuristic
	...
	public boolean accept(final String lex) {
		valuesSeen.putAll(forMap(Maps.asMap(DataType.parseableAs(lex), x -> lex)));
		return true;
	}
