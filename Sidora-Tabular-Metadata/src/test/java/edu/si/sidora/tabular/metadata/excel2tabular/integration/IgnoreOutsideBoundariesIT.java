...
public class IgnoreOutsideBoundariesIT {
    ...
    public void testOneSheetFile() throws IOException {
        final URL inputUrl = new File("src/test/resources/excel2tabular/xls/test-with-boundaries.xls").toURI().toURL();
        ...
        final URL checkFile = new File("src/test/resources/excel2tabular/tabular/test-with-boundaries.csv").toURI().toURL();
