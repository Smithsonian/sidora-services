...
public class RaggedEdgesIT {
    ...
    public void testOneSheetFile() throws IOException {
        final URL inputUrl = new File("src/test/resources/excel2tabular/xls/ragged-edges-test.xls").toURI().toURL();
        ...
        final URL checkFile = new File("src/test/resources/excel2tabular/tabular/ragged-edges-test.csv").toURI().toURL();
