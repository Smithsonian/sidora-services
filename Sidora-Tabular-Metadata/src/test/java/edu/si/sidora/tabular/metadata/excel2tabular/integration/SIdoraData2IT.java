...
public class SIdoraData2IT {
    ...
    public void test() throws IOException {
        final URL inputUrl = new File("src/test/resources/excel2tabular/xls/C14DATES.CJD.REVISION.3.13.xlsx").toURI().toURL();
        final URL result = testExcel2Csv.process(inputUrl).get(0).toURI().toURL();
        final URL checkFile = new File("src/test/resources/excel2tabular/tabular/C14DATES.CJD.REVISION.3.13.csv").toURI().toURL();
