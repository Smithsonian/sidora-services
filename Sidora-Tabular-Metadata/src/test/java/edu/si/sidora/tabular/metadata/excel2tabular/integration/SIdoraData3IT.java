...
public class SIdoraData3IT {
    ...
    public void test() throws IOException {
        final URL inputUrl = new File("src/test/resources/excel2tabular/xls/ArtefactosCJD.xls").toURI().toURL();
        final List<File> results = testExcel2Csv.process(inputUrl);

        final File[] checkFiles =
                new File("src/test/resources/excel2tabular/tabular/ArtefactosCJD-csvs").listFiles(new FilenameFilter() {
