...
package edu.si.sidora.tabular.metadata.generator.integration;

import static edu.si.sidora.tabular.metadata.generator.datatype.DataType.DateTime;
...
public class SidoraDataIT {
	...
	private static final String ITEST_DATA_DIR = "src/test/resources/generator/itest-data";
