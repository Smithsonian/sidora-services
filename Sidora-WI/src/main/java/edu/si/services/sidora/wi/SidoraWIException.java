 ...
 * @author jbirkhimer
 */
public class SidoraWIException extends Exception {

    /**
     * Same behavior is as the super class
     */
    public SidoraWIException() {
        super();
    }
     ...
     */
    public SidoraWIException(String message) {
        super(message);
    }
     ...
     */
    public SidoraWIException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause the cause of exception; same as the super class
     */
    public SidoraWIException(String message, Throwable cause) {
        super(message, cause);
    }
}
