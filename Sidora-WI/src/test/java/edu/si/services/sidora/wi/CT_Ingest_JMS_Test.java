...
public class CT_Ingest_JMS_Test extends CamelTestSupport {
    ...
    private static String fuskeiHost = "http://localhost:9080/fuseki/fedora3";
    private static String fedoraUser = "fedoraAdmin";
    private static String fedoraPasword = "fc";
    ...
    private static final RouteBuilder buildCtIngestMessage = new RouteBuilder() {
        ...
        public void configure() throws Exception {
            ...
            from("direct:start").routeId("BuildCtIngestMessageRoute")
                    ...
                    .to("activemq:queue:test.wi.ct.update")
            ...
            from("direct:sendFedoraAPIM")
                    ...
                    .toD("activemq:queue:test.wi.apim.update")
    ...
    public void sendCtIngestMessage(String project, String subProject, String plot, String deploymentPid) throws Exception {
        Exchange exchange = new DefaultExchange(context);
        exchange.getIn().setHeader("ProjectPID", project);
        exchange.getIn().setHeader("SubProjectPID", subProject);
        exchange.getIn().setHeader("PlotPID", plot);
    ...
    public void sendFedoraApimMessage(String pid, String label, String dsID, String mimeType, String fedoraModel, String user, String methodName) {
        ...
        String jmsMsg = template.requestBodyAndHeaders("velocity:file:{{karaf.home}}/fedora_atom.vsl", "test body", headers, String.class);
    ...
    /**
     * Folllowing test are for localhost and/or sidora0c quotient servers
     * @throws Exception
     */

    @Test
    public void test_local_testProjectId() throws Exception {
        sendCtIngestMessage("test.smx.home:12", "test.smx.home:13", "test.smx.home:14", "test.smx.home:15");
    }

    @Test
    public void test_local_fedoaraAPIM() {

        //sendFedoraApimMessage("test.smx.home:16", "testDeploymentIds1i1", "OBJ", "image/jpg", "info:fedora/si:generalImageCModel", "someUser", "modifyDatastreamByValue");

        //sendFedoraApimMessage("test.smx.home:22", "CSV", "CSV", "text/csv", "info:fedora/si:datasetCModel", "someUser", "modifyDatastreamByReference");

        //sidora0c quotient server
        sendFedoraApimMessage("ct:1689234", "FGDC Record", "FGDC", "text/xml", null, "someUser", "modifyDatastreamByReference");
    }
