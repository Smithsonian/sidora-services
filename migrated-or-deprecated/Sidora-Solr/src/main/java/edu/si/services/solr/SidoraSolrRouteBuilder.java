...
public class SidoraSolrRouteBuilder extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("direct:getFoxml").id("getFoxml")
                ...
                //.toD("http://localhost:8080/fedora/objects/${header.pid}/export?copyHeaders=false&mapHttpMessageHeaders=false&headerFilterStrategy=#dropHeadersStrategy").id("getFoxml")
